  ...
  return (
    ...
    >
      <div className='flex flex-wrap'>
        ...
        <div className='flex flex-[0_0_100%] p-2 md:flex-[0_0_50%] 2xl:flex-[0_0_33.3%]'>
          <NormalSelect
            placeholder='انتخاب نوع نمودار'
            options={[
              { value: '1', label: 'مینیمم سرعت' },
              { value: '2', label: 'میانگین سرعت' },
              { value: '3', label: 'ماکسیمم سرعت' },
            ]}
          />
        </div>
        <div className='flex flex-[0_0_100%] p-2 md:flex-[0_0_50%] 2xl:flex-[0_0_33.3%]'>
          <NormalSelect
            ...
            options={[
              ...
              { value: '3', label: 'یک ساعته' },
              { value: '4', label: '8 ساعته' },
              { value: '5', label: 'یک روزه' },
            ]}
          />
        </div>
        <div className='flex flex-[0_0_100%] p-2 md:flex-[0_0_50%] 2xl:flex-[0_0_33.3%]'>
